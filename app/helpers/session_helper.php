<?php
    ...
    // EXAMPLE - flash('register_success', 'You are no registered', 'alert alert-danger');
    ...
    function checkLoggedUserRol($rolTitle){
        foreach($_SESSION['user_roles'] as $rol){
            if($rol->nombreRol == $rolTitle){
                return true;
            }
        }
        return false;
