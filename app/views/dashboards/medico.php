                                ...
                                <tbody>
                                    <?php foreach($data['citasMedicas'] as $citaMedica) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle"><?php echo $citaMedica->especialidad ?></td>
                                            ...
                                            <td class="align-middle"><a class="btn btn-transparent btn-sm" href="<?php echo URLROOT; ?>/consultas/historiaMedica/<?php echo $citaMedica->idCitaMedica ?>"><i class="fas fa-notes-medical fa-2x text-info"></i></a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
