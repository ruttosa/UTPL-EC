                                    ...
                                    <tbody>
                                        <?php foreach($data['citasMedicas'] as $citaMedica) : ?>
                                            <tr>
                                                ...
                                                <td class="align-middle"><a class="btn btn-transparent btn-sm" href="<?php echo URLROOT; ?>/dashboard/cancelar/<?php echo $citaMedica->idCitaMedica ?>"><i class="fas fa-calendar-times fa-2x text-danger"></i></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
