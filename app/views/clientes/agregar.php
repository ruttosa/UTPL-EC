...
<div class="container">
    ...
    <p class="lead">Aquí podrás realizar el registro de un nuevo cliente en el sistema</p>
    <div>
        <?php flash('main_error'); ?>
        <?php flash('agregarCliente_error'); ?>       
        <?php flash('agregarCliente_success'); ?>
    </div>
    <div class="col-md-12">
        <div class="card p-3 shadow bg-info text-light">
            <div class="card-body">
                <form action="<?php echo URLROOT; ?>/clientes/agregar" method="post">
                    <div class="row">
                        <div class="col-md-6">
